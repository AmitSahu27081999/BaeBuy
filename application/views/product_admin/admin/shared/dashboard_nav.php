...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <img src="<?= base_url("/assets/admin/img/menu-icon/5.svg");?>" alt="">
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <img src="<?= base_url("/assets/admin/img/menu-icon/6.svg");?>" alt="">
                <span>Forms</span>
            </a>
            <ul>
                <li><a href="#">Elements</a>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <img src="<?= base_url("/assets/admin/img/menu-icon/7.svg");?>" alt="">
                <span>Charts</span>
            </a>
            <ul>
